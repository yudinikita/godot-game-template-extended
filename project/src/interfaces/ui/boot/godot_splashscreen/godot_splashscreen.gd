...
@export_file("*png") var logo_path = "res://src/interfaces/ui/boot/assets/images/godot_logo.png"
...
func config():
	...
	logo_container.position = center_point + Vector2(0, 0)
	...
	info_node.position = center_point + Vector2(0, 325)
